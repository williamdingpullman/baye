...
\NormalTok{gibbs<-}\ControlFlowTok{function}\NormalTok{(y,n_iter,init,prior)}
\NormalTok{\{}
\NormalTok{  ybar=}\KeywordTok{mean}\NormalTok{(y)}
\NormalTok{  n=}\KeywordTok{length}\NormalTok{(y)}
  
\NormalTok{  mu_out=}\KeywordTok{numeric}\NormalTok{(n_iter)}
\NormalTok{  sig2_out=}\KeywordTok{numeric}\NormalTok{(n_iter)}
  
\NormalTok{  mu_now=init}\OperatorTok{$}\NormalTok{mu}
  
\NormalTok{  ## Gibbs sampler}
  \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\NormalTok{n_iter)}
\NormalTok{  \{}
\NormalTok{    sig2_now=}\KeywordTok{update_sig2}\NormalTok{(}\DataTypeTok{n=}\NormalTok{n,}\DataTypeTok{y=}\NormalTok{y,}\DataTypeTok{mu=}\NormalTok{mu_now,}\DataTypeTok{nu_0 =}\NormalTok{ prior}\OperatorTok{$}\NormalTok{nu_}\DecValTok{0}\NormalTok{,}\DataTypeTok{beta_0 =}\NormalTok{ prior}\OperatorTok{$}\NormalTok{beta_}\DecValTok{0}\NormalTok{)}
\NormalTok{    mu_now=}\KeywordTok{update_mu}\NormalTok{(}\DataTypeTok{n=}\NormalTok{n,}\DataTypeTok{ybar=}\NormalTok{ybar, }\DataTypeTok{sig2 =}\NormalTok{ sig2_now,}\DataTypeTok{mu_0 =}\NormalTok{ prior}\OperatorTok{$}\NormalTok{mu_}\DecValTok{0}\NormalTok{,}\DataTypeTok{sig2_0 =}\NormalTok{ prior}\OperatorTok{$}\NormalTok{sig2_}\DecValTok{0}\NormalTok{)}
    
\NormalTok{    sig2_out[i]=sig2_now}
\NormalTok{    mu_out[i]=mu_now}
\NormalTok{  \}}
  \KeywordTok{cbind}\NormalTok{(}\DataTypeTok{mu=}\NormalTok{mu_out,}\DataTypeTok{sig2=}\NormalTok{sig2_out)}
\NormalTok{\}}
...
\NormalTok{prior=}\KeywordTok{list}\NormalTok{()}
\NormalTok{prior}\OperatorTok{$}\NormalTok{mu_}\DecValTok{0}\NormalTok{=}\DecValTok{0}
\NormalTok{prior}\OperatorTok{$}\NormalTok{sig2_}\DecValTok{0}\NormalTok{=}\DecValTok{1}

\NormalTok{prior}\OperatorTok{$}\NormalTok{n_}\DecValTok{0}\NormalTok{=}\DecValTok{2}
\NormalTok{prior}\OperatorTok{$}\NormalTok{s2_}\DecValTok{0}\NormalTok{=}\DecValTok{1}
\NormalTok{prior}\OperatorTok{$}\NormalTok{nu_}\DecValTok{0}\NormalTok{=prior}\OperatorTok{$}\NormalTok{n_}\DecValTok{0}\OperatorTok{/}\DecValTok{2}
\NormalTok{prior}\OperatorTok{$}\NormalTok{beta_}\DecValTok{0}\NormalTok{=prior}\OperatorTok{$}\NormalTok{n_}\DecValTok{0}\OperatorTok{*}\NormalTok{prior}\OperatorTok{$}\NormalTok{s2_}\DecValTok{0}\OperatorTok{/}\DecValTok{2}

\KeywordTok{hist}\NormalTok{(y,}\DataTypeTok{freq =} \OtherTok{FALSE}\NormalTok{,}\DataTypeTok{xlim=}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{3}\NormalTok{,}\DecValTok{3}\NormalTok{))}
\KeywordTok{curve}\NormalTok{(}\KeywordTok{dnorm}\NormalTok{(}\DataTypeTok{x=}\NormalTok{x,}\DataTypeTok{mean=}\NormalTok{prior}\OperatorTok{$}\NormalTok{mu_}\DecValTok{0}\NormalTok{,}\DataTypeTok{sd=}\KeywordTok{sqrt}\NormalTok{(prior}\OperatorTok{$}\NormalTok{sig2_}\DecValTok{0}\NormalTok{)),}\DataTypeTok{lty=}\DecValTok{2}\NormalTok{,}\DataTypeTok{add=}\OtherTok{TRUE}\NormalTok{)}
\KeywordTok{points}\NormalTok{(y,}\KeywordTok{rep}\NormalTok{(}\DecValTok{0}\NormalTok{,n),}\DataTypeTok{pch=}\DecValTok{1}\NormalTok{)}
\KeywordTok{points}\NormalTok{(ybar,}\DecValTok{0}\NormalTok{,}\DataTypeTok{pch=}\DecValTok{19}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{53}\NormalTok{)}
\NormalTok{init=}\KeywordTok{list}\NormalTok{()}
\NormalTok{init}\OperatorTok{$}\NormalTok{mu=}\DecValTok{0}

\NormalTok{post=}\KeywordTok{gibbs}\NormalTok{(}\DataTypeTok{y=}\NormalTok{y,}\DataTypeTok{n_iter =} \FloatTok{1e3}\NormalTok{,}\DataTypeTok{init=}\NormalTok{init,}\DataTypeTok{prior=}\NormalTok{prior)}
...
For instance, m=100e3 will look more stable thant m=10e3, even they
share the same sd=0.04.
...
\NormalTok{post0 =}\StringTok{ }\KeywordTok{mh}\NormalTok{(}\DataTypeTok{mu_now=}\FloatTok{0.0}\NormalTok{, }\DataTypeTok{m=}\FloatTok{10e3}\NormalTok{,}\DataTypeTok{type_MH=}\StringTok{"randomwalk"}\NormalTok{,}\DataTypeTok{cand_sd=}\FloatTok{0.9}\NormalTok{)}
\NormalTok{coda}\OperatorTok{::}\KeywordTok{traceplot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post0}\OperatorTok{$}\NormalTok{mu[}\OperatorTok{-}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{)]))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{post0}\OperatorTok{$}\NormalTok{accpt}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{61}\NormalTok{)}
\NormalTok{post1 =}\StringTok{ }\KeywordTok{mh}\NormalTok{(}\DataTypeTok{mu_now=}\FloatTok{0.0}\NormalTok{, }\DataTypeTok{m=}\FloatTok{10e3}\NormalTok{,}\DataTypeTok{type_MH=}\StringTok{"randomwalk"}\NormalTok{,}\DataTypeTok{cand_sd=}\FloatTok{0.04}\NormalTok{)}
\NormalTok{coda}\OperatorTok{::}\KeywordTok{traceplot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post1}\OperatorTok{$}\NormalTok{mu[}\OperatorTok{-}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{)]))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{post1}\OperatorTok{$}\NormalTok{accpt}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{61}\NormalTok{)}
\NormalTok{post2 =}\StringTok{ }\KeywordTok{mh}\NormalTok{(}\DataTypeTok{mu_now=}\FloatTok{0.0}\NormalTok{, }\DataTypeTok{m=}\FloatTok{100e3}\NormalTok{,}\DataTypeTok{type_MH=}\StringTok{"randomwalk"}\NormalTok{,}\DataTypeTok{cand_sd=}\FloatTok{0.04}\NormalTok{)}
\NormalTok{coda}\OperatorTok{::}\KeywordTok{traceplot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post2}\OperatorTok{$}\NormalTok{mu[}\OperatorTok{-}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{10}\NormalTok{)]))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{post2}\OperatorTok{$}\NormalTok{accpt}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coda}\OperatorTok{::}\KeywordTok{autocorr.plot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post0}\OperatorTok{$}\NormalTok{mu))}
\end{Highlighting}
\end{Shaded}

\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-20-4.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coda}\OperatorTok{::}\KeywordTok{autocorr.diag}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post0}\OperatorTok{$}\NormalTok{mu))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coda}\OperatorTok{::}\KeywordTok{autocorr.plot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post1}\OperatorTok{$}\NormalTok{mu))}
\end{Highlighting}
\end{Shaded}

\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-20-5.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coda}\OperatorTok{::}\KeywordTok{autocorr.diag}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post1}\OperatorTok{$}\NormalTok{mu))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coda}\OperatorTok{::}\KeywordTok{autocorr.plot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post2}\OperatorTok{$}\NormalTok{mu))}
\end{Highlighting}
\end{Shaded}

\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-20-6.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coda}\OperatorTok{::}\KeywordTok{autocorr.diag}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post2}\OperatorTok{$}\NormalTok{mu))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coda}\OperatorTok{::}\KeywordTok{effectiveSize}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post2}\OperatorTok{$}\NormalTok{mu)) }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# thin out the samples until autocorrelation is essentially 0. }
\CommentTok{# This will leave you with approximately independent samples. }
\CommentTok{# The number of samples remaining is similar to the effective sample size.}
\NormalTok{coda}\OperatorTok{::}\KeywordTok{autocorr.plot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post2}\OperatorTok{$}\NormalTok{mu), }\DataTypeTok{lag.max=}\DecValTok{500}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{thin_interval =}\StringTok{ }\DecValTok{400} \CommentTok{# how far apart the iterations are for autocorrelation to be essentially 0.}
\NormalTok{thin_indx =}\StringTok{ }\KeywordTok{seq}\NormalTok{(}\DataTypeTok{from=}\NormalTok{thin_interval, }\DataTypeTok{to=}\KeywordTok{length}\NormalTok{(post2}\OperatorTok{$}\NormalTok{mu), }\DataTypeTok{by=}\NormalTok{thin_interval)}
\KeywordTok{head}\NormalTok{(thin_indx)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{post2mu_thin =}\StringTok{ }\NormalTok{post2}\OperatorTok{$}\NormalTok{mu[thin_indx]}
\KeywordTok{traceplot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post2}\OperatorTok{$}\NormalTok{mu))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{traceplot}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post2mu_thin))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coda}\OperatorTok{::}\KeywordTok{effectiveSize}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post0}\OperatorTok{$}\NormalTok{mu)) }\CommentTok{# effective sample size of ~2,500}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nburn =}\StringTok{ }\DecValTok{1000} \CommentTok{# remember to discard early iterations}
\NormalTok{post0}\OperatorTok{$}\NormalTok{mu_keep =}\StringTok{ }\NormalTok{post0}\OperatorTok{$}\NormalTok{mu[}\OperatorTok{-}\KeywordTok{c}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{1000}\NormalTok{)]}
\KeywordTok{summary}\NormalTok{(}\KeywordTok{as.mcmc}\NormalTok{(post0}\OperatorTok{$}\NormalTok{mu_keep))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(post0}\OperatorTok{$}\NormalTok{mu_keep }\OperatorTok{>}\StringTok{ }\FloatTok{1.0}\NormalTok{) }\CommentTok{# posterior probability that mu  > 1.0}
\end{Highlighting}
\end{Shaded}
